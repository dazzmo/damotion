...
class LinearCost : public Cost {
 public:
  LinearCost(const std::string &name, const Eigen::VectorXd &c, const double &b,
    ...
    // Create the Cost
    casadi::Function f = casadi::Function(this->name(), in, {linear_cost, b});
...
class QuadraticCost : public Cost {
 public:
  QuadraticCost(const std::string &name, const Eigen::MatrixXd &Q,
    ...
    casadi::Function fg =
        casadi::Function(this->name() + "_grd", in, {mtimes(Qs, x) + gs, gs});
  ...
  QuadraticCost(const std::string &name, const sym::Expression &ex,
    ...
    casadi::Function fh =
        casadi::Function(this->name() + "_hes", in, {2.0 * Q});
