...
//     : prog_(prog), Ipopt::TNLP(), SparseSolver(prog) {}
...
//                                  Number& obj_value) {
//   if (new_x) {
//     decision_variable_cache_ = Eigen::Map<VectorXd>(const_cast<double*>(x),
//     n);
//   }
//   // Update caches
...
//     const Eigen::SparseMatrix<double>& Jc =
//     prog_.GetSparseConstraintJacobian(); int cnt = 0; for (int k = 0; k <
//     Jc.outerSize(); ++k) {
...
//     prog_.GetSparseLagrangianHessian(); int cnt = 0; for (int k = 0; k <
//     H.outerSize(); ++k) {
...
//   Ipopt::SmartPtr<Ipopt::TNLP> nlp = new Ipopt::IpoptSolverInstance(prog_);

//   // Create a new instance of IpoptApplication
//   //  (use a SmartPtr, not raw)
//   // We are using the factory, since this allows us to compile this
//   // example with an Ipopt Windows DLL
//   Ipopt::SmartPtr<IpoptApplication> app = Ipopt::IpoptApplicationFactory();
