...
Eigen::Matrix<casadi::SX, 3, -1> damotion::log3(
  ...
  casadi::SX cond_theta = if_else(trace_less_than_lb, M_PI, acos((tr - 1) / 2));
...
template <>
void damotion::Jlog3(casadi::SX &theta,
                     const Eigen::Matrix<casadi::SX, 3, 1> &log,
...
template <>
Eigen::Matrix<casadi::SX, 6, -1> damotion::log6(
    const Eigen::Matrix<casadi::SX, 3, 3> &R,
...
template <>
void damotion::Jlog6(const Eigen::Matrix<casadi::SX, 3, 3> &R,
                     const Eigen::Matrix<casadi::SX, 3, 1> &p,
